...
public class MyGameReceiver : GameReceiver {
    ...
    public void SocketSetGoalPosition(string data) {
        if(OnSetGoalPosition != null) OnSetGoalPosition(JsonUtility.FromJson<PositionData>(data));
    }

    public void SocketPlayerWonRound() {
        if(OnPlayerWonRound != null) OnPlayerWonRound();
    }

    public void SocketPlayerLostRound() {
        if(OnPlayerLostRound != null) OnPlayerLostRound();
    }
